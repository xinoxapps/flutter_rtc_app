...
class _MediaControls extends StatefulWidget {
  ...
  /// Enables the control for the rewind/forward in the media control.
  final bool? enableRewindControl;
...
class _MediaControlsState extends State<_MediaControls> {
    ...
    return Container(
      ...
      child: Column(
        ...
        children: <Widget>[
          ...
          if (_shouldBuildRewindControl()) _buildProgressionBar(),
        ],
      ),
    );
  }
  ...
  bool _shouldBuildRewindControl() {
    bool enabled = widget.enableRewindControl ?? false;
    bool hasCallback = widget.onPositionChanged != null;
    return enabled && hasCallback;
  }
}
